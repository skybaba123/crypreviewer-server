...
const rejectWithdrawalHandler = async (req: any, res: any) => {
  try {
    ...
    await User.findByIdAndUpdate(user._id, {
      $inc: { accountBal: transaction.amount },
    });
    ...
    const emailText = `Hello ${user.username},| Your withdrawal of ${company.currency.symbol}${updatedTransaction.amount} failed.`;
...
export default rejectWithdrawalHandler;
